...
<body>
    ...
    <main>
        ...
        <div class="container" id="lista-productos">
            ...
            <div class="card-deck mb-4 text-center">
                ...
                <div class="card mb- shadow-sm">
                    ...
                    <div class="card-body">
                        <img src="img/carro10.png" class="card-img-top" width="200px">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <img src="img/carro5.png" class="card-img-top">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <img src="img/carro11.png" class="card-img-top">
            ...
            <div class="card-deck mb-3 text-center">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <img src="img/carro1.jpg" class="card-img-top">
                        <h1 class="card-title pricing-card-title precio">R$<span class="">37.900</span></h1>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <img src="img/carro2.jpg" class="card-img-top">
                        <h1 class="card-title pricing-card-title precio">R$<span class="">37.900</span></h1>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <img src="img/carro3.jpg" class="card-img-top">
                        <h1 class="card-title pricing-card-title precio">R$<span class="">37.900</span></h1>
            ...
            <div class="card-deck mb-3 text-center">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <img src="img/moto14.png" class="card-img-top">
                        <h1 class="card-title pricing-card-title precio">R$<span class="">37.900</span></h1>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <img src="img/moto12.png" class="card-img-top">
                        <h1 class="card-title pricing-card-title precio">R$<span class="">37.900</span></h1>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <img src="img/moto13.png" class="card-img-top">
                        <h1 class="card-title pricing-card-title precio">R$<span class="">37.900</span></h1>
        ...
        <div class="buttons" style="margin-left: 370px; margin-bottom: 20px;">
              <a href="carrinho.php" class="previous" style="margin-left:50px ;">&laquo; Anterior</a>
              <a href="#" style="padding-left: 10px;">1</a>
              <a href="#">2</a>
              <a href="#" >3</a>
               <a href="#" >4 ...</a>
              <a href="carrinho.html" class="next" style="margin-left:10px;">Proximo &raquo;</a>
        </div>
    </main>
